...
class TextDialog(
    ...
    private val viewModel: TextViewModel by viewModels(
        ...
        creator = { textViewModel() },
    )

    /** ViewBinding containing the views for this dialog. */
    private lateinit var viewBinding: DialogConfigActionTextBinding

    override fun onCreateView(): ViewGroup {
        viewBinding = DialogConfigActionTextBinding.inflate(LayoutInflater.from(context)).apply {
            layoutTopBar.apply {
                dialogTitle.setText(R.string.dialog_overlay_title_text)
    ...
    private fun updateClickPositionUiState(state: TextPositionUiState?) {
        state ?: return
